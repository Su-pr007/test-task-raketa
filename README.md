# Тестовое задание для компании RAKETA
Изменения внесены, в некоторых местах дописаны комментарии. Поверхностное описание изменений в файле [code-review.md](./code-review.md)
...
- Реализовать сохранение и получение корзины;
